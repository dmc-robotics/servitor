/**
 * Icon SVG markup
 * Inner elements of 24x24 stroke icons, rendered by `@/components/Icon.vue`.
 *
 * Copied from Lucide (https://lucide.dev), ISC License,
 * Copyright (c) Lucide Contributors. To add an icon, copy the inner
 * elements of its SVG from lucide.dev and add an entry below.
 */
